...
boolean isNotCustomDockbar = layoutSet != null && ("".equals(layoutSet.getThemeId()) || "classic".equals(layoutSet.getThemeId()));
%>

<c:choose>
	<%-- Need to have a better way to determine when to use custom dockbar --%>
	<c:when test="<%= group.isControlPanel() || isNotCustomDockbar%>">
...
<aui:script position="inline" use="liferay-dockbar">
	...
	<c:otherwise>
		<liferay-util:include page="/html/portlet/dockbar/view-custom.jsp" useCustomPage="false" />
	</c:otherwise>
</c:choose>